  ...
  return (
    <div>
      ...
      <div id="boxrow1">
        ...
        <img id="logo2" src='./Images/united-social-federation.png'  alt="Logo" />
        <p className='box-title'>United Social Federation
        </p>
        </div>
        <div className="item" id="box2">
        <img id="logo2" src='./Images/social-panchayat.png'  alt="Logo" />
        <p className='box-title'>The social panchayat
        </p>
        ...
        <p className='box-title'>The Ultra Bharat </p></div>
      </div>
      ...
      <div id="boxrow2">
        ...
        <img id="logo2" src='./Images/white_logo.png'  alt="Logo" />
        <p className='box-title'>The X Founders </p></div>
        <div className="item" id="box7"> 
         <img id="logo2" src='./Images/white_logo.png'  alt="Logo" />
        <p className='box-title'>The Holistic Incubation</p></div>
