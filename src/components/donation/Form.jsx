  ...
  return (
    <form id="donation-form">
      ...
      <div className="pan-field">
        <label for="username">PAN Card</label>
        <input
      ...
      <div className="checkbox-container">
        ...
        <div className="declare">
          ...
          best of my knowledge. I know that all further communications will be
          done on contact details provided above
        </div>
      </div>

      <img
        className="form-image"
        src="./Images/cards-payment-strip2.png"
        alt="error"
      />
